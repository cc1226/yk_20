...
public class NodeUtils {
    ...
    public static void clickNode(String text, String id) {
        ...
        List<String> nodeList = AdbUtils.getAdbUtils().getNodeList(AdbUtils.getAdbUtils().dumpXml2String());
    ...
    public static void clickLong(String text, String id) {
        ...
        for (int i = 0; i < nodeList.size(); i++) {
            ...
            if (node != null && node.getResourceid() != null && node.getResourceid().equals(id)) {
                if (!TextUtils.isEmpty(node.getText()) && !TextUtils.isEmpty(text) && node.getText().contains(text)) {
                    List<Integer> xy = AdbUtils.getAdbUtils().getXY(node.getBounds());
                    AdbUtils.getAdbUtils().clickLong(xy.get(0), xy.get(1), xy.get(2), xy.get(3));
                    break;
                }
            }
        }
    ...
    private static void clickLong(String id, long time) {
        ...
        for (int i = 0; i < nodeList.size(); i++) {
            ...
            if (node != null && node.getResourceid() != null && node.getResourceid().equals(id)) {
                List<Integer> xy = AdbUtils.getAdbUtils().getXY(node.getBounds());
                AdbUtils.getAdbUtils().clickLong(xy.get(0), xy.get(1), xy.get(2), xy.get(3), time);
                break;
            }
        }
    }
